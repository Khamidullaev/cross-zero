...
let diagonal2 = 0;
                ...
                for (let i = 0; i < 3; i++) {
                    for (let j = 0; j < 3; j++){
                        switch (i) {
                            case 0: row1 += b[i][j]; break;
                            case 1: row2 += b[i][j]; break;
                            case 2: row3 += b[i][j]; break;
                        }  
                        
                        switch (j) {
                            case 0: column1 += b[i][j]; break;
                            case 1: column2 += b[i][j]; break;
                            case 2: column3 += b[i][j]; break;
                        } 

                        if(i==j) diagonal1 += b[i][j];
                        if(i+j==2) diagonal2 += b[i][j];

                    }
                }
                if(row1==6||row2==6||row3==6||column1==6||column2==6||column3==6||diagonal1==6||diagonal2==6) iksWin();
                if(row1==30||row2==30||row3==30||column1==30||column2==30||column3==30||diagonal1==30||diagonal2==30) nolikWin();
                ...
                if (score == 9&&column1!=6&&column1!=30&&column2!=6&&column2!=30&&column3!=6&&column3!=30&&row1!=6&&row1!=30&&row2!=6&&row2!=30&&row3!=6&&row3!=30&&diagonal1!=6&&diagonal1!=30&&diagonal2!=6&&diagonal2!=30) alert('Durang!');
